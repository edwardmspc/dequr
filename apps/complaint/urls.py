...
from .views import (IndexView,CreateComplaintLastStepView,ProfileView,\
    AjaxCompany,AjaxLoadCategoryFromAutocompleteCompany,AjaxLoadSubCategory,\
    CreateComplaintStepOneWizard,MultiUploadAjax,CreateComplaintFinishView,\
    FORMS)
